 ...
 */
package src.com.brunomnsilva.smartgraph.graph;
...
public class DigraphEdgeList<V, E> implements Digraph<V, E> {
    ...
    @Override
    public synchronized Collection<Edge<E, V>> incidentEdges(V inbound) throws InvalidVertexException {
    	return this.incidentEdges(vertexOf(inbound));
    }
    @Override
    ...
    @Override
    public synchronized Collection<Edge<E, V>> outboundEdges(V outbound) throws InvalidVertexException {
        return this.outboundEdges(vertexOf(outbound));
    }
    @Override
    ...
    @Override
    public synchronized V removeVertex(V v) throws InvalidVertexException {
    	return removeVertex(vertexOf(v));
    }
